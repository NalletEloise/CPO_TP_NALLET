...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(texte_intro, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, -1, -1));

        bouton_tester.setText("Tester");
        getContentPane().add(bouton_tester, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 200, -1, -1));
        ...
        getContentPane().add(texte_nb_chiffres_exacts, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, -1, -1));
        ...
        getContentPane().add(texte_nb_chiffres_haut, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, -1, -1));

        texte_lbl_nb_chiffres_bas.setText("Nombres trop bas :");
        getContentPane().add(texte_lbl_nb_chiffres_bas, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, -1));

        texte_nb_chiffres_bas.setText("nb bas");
        getContentPane().add(texte_nb_chiffres_bas, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, -1, -1));

        texte_score.setText("SCORE");
        getContentPane().add(texte_score, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, -1, -1));
